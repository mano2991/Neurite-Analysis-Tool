...
def neurite_classifier(out_classes=2, filter_scale=0, dense_size=128, input_shape=[1024, 1360, 1], out_layers=1, out_drop=0.2, generic=False, **kwargs):
    ...
    out_drop : float
        The amount of dropout to apply to the penultimate fully-connected layer
    generic : bool
        If true, removes the side modules from the model structure
    """
    ...
    dense_drop = Dropout(out_drop, name="last_drop")(dense1)
